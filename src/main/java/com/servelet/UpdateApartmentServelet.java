...
/**
 * Servlet implementation class UpdateApartmentServelet
 */
@WebServlet("/UpdateApartmentServelet")
@MultipartConfig(
	    fileSizeThreshold = 1024 * 1024 * 2,  // 2MB
	    maxFileSize = 1024 * 1024 * 10,       // 10MB
	    maxRequestSize = 1024 * 1024 * 50     // 50MB
	)
public class UpdateApartmentServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateApartmentServelet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean isTrue = ApartmentDao.updateProduct(apartmentId, apartmentname, location, numberOfRooms, price, imageUrl);
